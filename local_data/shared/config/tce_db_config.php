 ...
 */
define ('K_DATABASE_HOST', getenv("OPENSHIFT_MYSQL_DB_HOST"));

/**
 * database port (eg: 3306, 5432, 1521)
 */
define ('K_DATABASE_PORT', getenv("OPENSHIFT_MYSQL_DB_PORT"));

/**
 * database name (TCExam)
 */
define ('K_DATABASE_NAME', getenv("OPENSHIFT_APP_NAME"));

/**
 * database user name
 */
define ('K_DATABASE_USER_NAME', getenv("OPENSHIFT_MYSQL_DB_USERNAME"));

/**
 * database user password
 */
define ('K_DATABASE_USER_PASSWORD', getenv("OPENSHIFT_MYSQL_DB_PASSWORD"));
